...
/**
 * OCEAN_Pricing_TC16_17_20 class automates Ocean Pricing module Test Condition
 * 16,17 and 20, which holds 8 Test Case; Test Condition Description : Editing
 * of Pricing, options, surcharges, deductibles in master price sheet
 * 
 * @author Nainsi Jain
 * 
...
public class OCEAN_Pricing_TC_16_17_20 extends PricingModulePages {
	...
	@Test(priority = 3, groups = { "regression", "smoke",
			"fullSuite" }, dataProvider = "fetchDataForTC16_17", dataProviderClass = PricingDataProvider.class, description = "Editing of Pricing, options, surcharges, deductibles in mater price sheet")
	public void editingandVerifyPriceSheet(String[] inputArray) throws Exception {
		...
		assertEquals(valueFlag == surchargesFlag == optionsFlag == deductiblesFlag == true, true);
	}
}
