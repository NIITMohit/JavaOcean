 ...
 * @reviewer : Mohit Goel
 */
public class OCEAN_UnderWriting_TC_01_02_03_04_10_12 extends UnderwritingModulePages {
	/**
	...
	@Test(priority = 1, groups = { "regression", "extendSmoke", "smoke",
			"fullSuite" }, dataProvider = "fetchDataForTC01_02_03_04", dataProviderClass = UnderwritingDataProvider.class, description = "Validate the creation of remittance in ocean")
	public void createRemittance(String[] inputArray) throws Exception {
		...
		if (inputArray[4] == "" || inputArray[5] == "" || inputArray[0] == "" || inputArray[1] == ""
			...
			uiValues.put("Paper", excelValues.get("Paper"));
